    ...
    return (
      <>
        <div className='flex w-full bg-white rounded-xl '>
          <div className="flex-1 p-10">
            <div className="font-extrabold text-[48px] mt-10">
              <div>I&lsquo;m Alvino Risca Anggara Putra
              </div>
              <div>
                <span className="text-[#FFB400]">Fullstack</span> Developer 
              </div>
            </div>
            <p className="text-[#767676]">Perkenalkan nama saya alvino dari mahasiswa Politeknik LP3I jakarta.</p>
        ...
        <div className="mt-20 text-center">
          <h2 className="text-[32px] font-bold">My Skill</h2>
